...
export default class IndexRoute extends Route {
  ...
  afterModel() {
    ...
    this.headData.keywords =
      'talik comment integration platform opensource free easy ';
    this.headData.language = 'English';
    this.headData.description =
      'Talik is an open source platform that provides an easy and efficient way to integrate comments on your web pages, and allow people to ask questions or give feedback. ';
    this.headData.ogImage = 'https://talik.io/assets/images/header-image.svg';
    this.headData.ogDescription =
      'Talik is an open source platform that provides an easy and efficient way to integrate comments on your web pages, and allow people to ask questions or give feedback.';
